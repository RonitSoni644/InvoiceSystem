...
- **Local Storage:**
  ...
  - Instant loading
- **Sample Data:**
  - Pre-loaded with demo invoices
  - Demo customers and products
...
### Customers (3)
1. Rajesh Kumar - Mumbai, Maharashtra
2. Priya Sharma - Bangalore, Karnataka
3. Amit Patel - Ahmedabad, Gujarat

### Products/Services (5)
1. Website Design - ₹50,000
2. SEO Optimization - ₹15,000
3. Mobile App Development - ₹1,20,000
4. Logo Design - ₹8,000
5. Content Writing - ₹5,000

### Invoices (3)
1. INV-001 - Paid - ₹76,700
2. INV-002 - Partial - ₹1,41,600
3. INV-003 - Unpaid - ₹9,440
...
- This is a **demo application** running in your browser
